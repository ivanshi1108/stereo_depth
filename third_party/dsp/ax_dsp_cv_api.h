...
#define AX_DSP_CMD_OPERATOR_NV12ROTATE (AX_DSP_CMD_OPERATOR + 11)
#define AX_DSP_CMD_OPERATOR_SAD_EX (AX_DSP_CMD_OPERATOR + 13)
#define AX_DSP_CMD_OPERATOR_DFT_INIT (AX_DSP_CMD_OPERATOR + 14)
#define AX_DSP_CMD_OPERATOR_DFT_RUN  (AX_DSP_CMD_OPERATOR + 15)
#define AX_DSP_CMD_OPERATOR_RESIZE_OPENCV (AX_DSP_CMD_OPERATOR + 16)
#define AX_DSP_CMD_OPERATOR_RESIZE_PAD (AX_DSP_CMD_OPERATOR + 17)
...
typedef enum {
    ...
    AX_DSP_CV_CVTCOLOR_AX_BAYER_RAW_8BPP_YUV,
    AX_DSP_CV_CVTCOLOR_NV12_I420,
    AX_DSP_CV_CVTCOLOR_UYVY_NV12,
    AX_DSP_CV_CVTCOLOR_YUYV_NV12,
...
typedef struct
{
    ...
    AX_U64 ctxSize;
} AX_DSP_CV_DFT_RUN_PARAM_T;

typedef struct {
    AX_DSP_CV_FORMAT_E format; /* AX_DSP_CV_FORMAT_E, only support AX_DSP_CV_FORMAT_NV12 */
    AX_U32 src_height;
    AX_U32 src_width;
    AX_U32 src_stride;
    AX_U32 dst_height;     /* dst height, including padding */
    AX_U32 dst_width;      /* dst width, including padding */
    AX_U32 dst_stride;
    AX_U32 inter_type;
    AX_F32 crop_x;
    AX_F32 crop_y;
    AX_F32 crop_w;
    AX_F32 crop_h;
    AX_U32 pad[4];         /* t,b,l,r, nv12 format pad must be even */
    AX_U8  pad_val_y;      /* pad value y */
    AX_U8  pad_val_uv;     /* pad value uv */
    AX_S32 reserved[4];    /* reserved */
} AX_DSP_CV_RESIZE_PAD_PARAM_T;
...
int AX_DSP_CV_ResizeRGB(int dsp_id, AX_MEM_INFO_T *in_buf, AX_MEM_INFO_T *out_buf, AX_DSP_CV_RESIZE_PARAM_T *param);
int AX_DSP_CV_ResizeOpencv(int dsp_id, AX_MEM_INFO_T *in_buf, AX_MEM_INFO_T *out_buf, AX_DSP_CV_RESIZE_PARAM_T *param);
int AX_DSP_CV_ResizeWithPad(int dsp_id, AX_MEM_INFO_T *in_buf, AX_MEM_INFO_T *out_buf, AX_DSP_CV_RESIZE_PAD_PARAM_T *param);
...
int AX_DSP_CV_NV12Rotate(int dsp_id, AX_DSP_CV_NV12Rotate_PARAM_T *param);
int AX_DSP_CV_DFT_Init(int dsp_id, AX_DSP_CV_DFT_INIT_PARAM_T *param);
int AX_DSP_CV_DFT_Run(int dsp_id, AX_DSP_CV_DFT_RUN_PARAM_T *param);
